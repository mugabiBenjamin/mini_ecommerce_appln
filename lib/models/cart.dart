...
class Cart extends ChangeNotifier {
  // List of available shoes for sale
  final List<Shoe> _shoeShop = [
    Shoe(
      'UA Charged Assert 10',
      'assets/img/UA-Charged-Assert-10.jpg',
      'A versatile athletic shoe designed for running and training.',
      556.99,
    ),
    Shoe(
      'UA Charged Bandit Trail 3',
    ...
    Shoe(
      'UA Charged Rogue 4',
      'assets/img/UA-Charged-Rogue-4.jpg',
      'Balances comfort and speed on the run.',
      500.99,
    ),
    Shoe(
      'Curry Flow 9',
      'assets/img/UA-Curry-Flow-9.jpg',
      'Endorsed by Stephen Curry, known for speed and agility.',
      771.99,
    ),
    Shoe(
      'UA Drift Rn Mineral',
      'assets/img/UA-Drift-Rn-Mineral.jpg',
      'Features a sleek design suitable for everyday use.',
      599.00,
    ),
    Shoe(
      'UA Highlight TM',
      'assets/img/UA-Highlight-TM.jpg',
      'High-top cleats providing ankle support and traction.',
      800.00,
    ),
    Shoe(
      'UA HOVR Drive Pro',
      'assets/img/UA-HOVR-Drive-Pro.jpg',
      'Blends performance technology with everyday style.',
      765.00,
    ),
    Shoe(
      'UA HOVR Phantom 3 SE',
      'assets/img/UA-HOVR-Phantom-3-SE.jpg',
      'Known for its cushioning and energy return.',
      687.99,
    ),
    Shoe(
      'UA HOVR Sonic 4',
      'assets/img/UA-HOVR-Sonic-4.jpg',
      'Offers a lightweight fit and responsiveness.',
      700.50,
    ),
    Shoe(
      'UA Lock Down 7',
      'assets/img/UA-Lock-Down-7.jpg',
      'Focused on stability and support during play.',
      667.99,
    ),
    Shoe(
      'UA Magnetico Pro 3',
      'assets/img/UA-Magnetico-Pro-3.jpg',
      'Offers a soft feel and excellent ball control.',
      556.80,
    ),
    Shoe(
      'UA Micro G Pursuit BP',
      'assets/img/UA-Micro-G-Pursuit-BP.jpg',
      'Features a responsive midsole for dynamic movements.',
      600.00,
    ),
    Shoe(
      'UA Phantom 4',
      'assets/img/UA-Phantom-4.jpg',
      'Lightweight with a focus on speed and control on the field.',
      777.99,
    ),
    Shoe(
      'UA Project Rock 3',
    ...
    Shoe(
      'UA Slingride 2',
      'assets/img/UA-Slingride-2.jpg',
      'Lightweight and flexible, great for casual wear.',
      762.99,
    ),
    Shoe(
      'UA Speedform SS17',
      'assets/img/UA-Speedform-SS17.jpg',
      'Focuses on a snug fit for enhanced performance.',
      810.00,
    ),
    Shoe(
      'UA Spotlight Clone 3.0 MC',
  ...
  // Get the list of shoes available for sale
  List<Shoe> getShoeList() => _shoeShop;

  // Get the list of items in the cart
  List<Shoe> getCart() => userCart;
